...
const Index = () => {
  ...
  const handleClose = () => {
    ...
    setTimeout(() => {
      setCurrentStep('home');
      setFormData({ workSchedule: '', age: '', proximity: '' });
      setIsAnimating(false);
    }, 400);
  };
        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          ...
          <header className="pt-8 px-6 text-center animate-slide-down">
            <div className="flex items-center justify-center gap-3 mb-2">
              ...
              <h1 className="text-white text-xl font-medium tracking-wider">ARBAT NT</h1>
            </div>
          </header>
      ...
      {currentStep !== 'home' && (
        <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 ${
          ...
          <div className="modal-content relative bg-white rounded-2xl max-w-lg w-full p-8 shadow-2xl">
            ...
            {currentStep === 'schedule' && (
              <div className="pt-4 animate-slide-up">
                ...
                <div className="flex justify-between mt-8">
                  ...
                  <button
                    onClick={() => handleNext('workSchedule', formData.workSchedule)}
                    disabled={!formData.workSchedule}
            ...
            {currentStep === 'age' && (
              <div className="pt-4 animate-slide-up">
                ...
                <div className="flex justify-between mt-8">
                  ...
                  <button
                    onClick={() => handleNext('age', formData.age)}
            ...
            {currentStep === 'proximity' && (
              <div className="pt-4 animate-slide-up">
                ...
                <div className="flex justify-between mt-8">
                  ...
                  <button
                    onClick={() => handleNext('proximity', formData.proximity)}
                    disabled={!formData.proximity}
                    className="px-6 py-2 bg-blue-600 text-white rounded-lg disabled:bg-gray-300 disabled:cursor-not-allowed hover:bg-blue-700 transition-colors"
                  >
                    Далее
                  </button>
            ...
            {/* Success Step */}
            {currentStep === 'success' && (
              <div className="pt-4 text-center animate-zoom-in">
